Rails.application.routes.draw do
  ...
  post '/pets/applications/:applicationid/:petid', to: 'applications#update'
  patch '/pets/applications/:applicationid/submit', to: 'applications#update'
  get '/pets/applications/:id', to: 'applications#show'
  get '/pets/applications', to: 'applications#index'
  ...
  get '/admin/applications/:id', to: 'admin_apps#show'
  post '/admin/applications/:application_id/:pet_id', to: 'admin_apps#update'
